...
public class ClubAccountRecord extends TableRecordImpl<ClubAccountRecord> implements Record6<Long, ClubAccountRole, Boolean, Timestamp, Long, Long> {

    private static final long serialVersionUID = 1581748164;
     ...
     */
    @Override
    public Row6<Long, ClubAccountRole, Boolean, Timestamp, Long, Long> fieldsRow() {
     ...
     */
    @Override
    public Row6<Long, ClubAccountRole, Boolean, Timestamp, Long, Long> valuesRow() {
     ...
     */
    @Override
    public ClubAccountRecord value3(Boolean value) {
        setAccepted(value);
        return this;
    }
     ...
     */
    @Override
    public ClubAccountRecord values(Long value1, ClubAccountRole value2, Boolean value3, Timestamp value4, Long value5, Long value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ClubAccountRecord(Long id, ClubAccountRole role, Boolean accepted, Timestamp createdAt, Long clubId, Long accountId) {
        super(ClubAccount.CLUB_ACCOUNT);
