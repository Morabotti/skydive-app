...
public class Indexes {
    ...
    public static final Index ACTIVITY_FK_ACTIVITY_CLUB_ID = Indexes0.ACTIVITY_FK_ACTIVITY_CLUB_ID;
    public static final Index ACTIVITY_ID = Indexes0.ACTIVITY_ID;
    public static final Index ACTIVITY_TOKEN = Indexes0.ACTIVITY_TOKEN;
    ...
    public static final Index JUMP_FK_JUMP_ACTIVITY_ID = Indexes0.JUMP_FK_JUMP_ACTIVITY_ID;
    public static final Index JUMP_ID = Indexes0.JUMP_ID;
    public static final Index PILOT_ACTIVITY_PARTICIPATION_ACCOUNT_ID = Indexes0.PILOT_ACTIVITY_PARTICIPATION_ACCOUNT_ID;
    public static final Index PILOT_ACTIVITY_PARTICIPATION_FK_PILOT_ACTIVITY_PARTICIPATION_ACTIVITY_ID = Indexes0.PILOT_ACTIVITY_PARTICIPATION_FK_PILOT_ACTIVITY_PARTICIPATION_ACTIVITY_ID;
    public static final Index PILOT_ACTIVITY_PARTICIPATION_FK_PILOT_ACTIVITY_PARTICIPATION_PLANE_ID = Indexes0.PILOT_ACTIVITY_PARTICIPATION_FK_PILOT_ACTIVITY_PARTICIPATION_PLANE_ID;
    public static final Index PILOT_ACTIVITY_PARTICIPATION_ID = Indexes0.PILOT_ACTIVITY_PARTICIPATION_ID;
    ...
    private static class Indexes0 {
        ...
        public static Index ACTIVITY_FK_ACTIVITY_CLUB_ID = Internal.createIndex("fk_activity_club_id", Activity.ACTIVITY, new OrderField[] { Activity.ACTIVITY.CLUB_ID }, false);
        public static Index ACTIVITY_ID = Internal.createIndex("id", Activity.ACTIVITY, new OrderField[] { Activity.ACTIVITY.ID }, true);
        public static Index ACTIVITY_TOKEN = Internal.createIndex("token", Activity.ACTIVITY, new OrderField[] { Activity.ACTIVITY.TOKEN }, true);
        ...
        public static Index JUMP_FK_JUMP_ACTIVITY_ID = Internal.createIndex("fk_jump_activity_id", Jump.JUMP, new OrderField[] { Jump.JUMP.ACTIVITY_ID }, false);
        public static Index JUMP_ID = Internal.createIndex("id", Jump.JUMP, new OrderField[] { Jump.JUMP.ID }, true);
        public static Index PILOT_ACTIVITY_PARTICIPATION_ACCOUNT_ID = Internal.createIndex("account_id", PilotActivityParticipation.PILOT_ACTIVITY_PARTICIPATION, new OrderField[] { PilotActivityParticipation.PILOT_ACTIVITY_PARTICIPATION.ACCOUNT_ID, PilotActivityParticipation.PILOT_ACTIVITY_PARTICIPATION.ACTIVITY_ID }, true);
        public static Index PILOT_ACTIVITY_PARTICIPATION_FK_PILOT_ACTIVITY_PARTICIPATION_ACTIVITY_ID = Internal.createIndex("fk_pilot_activity_participation_activity_id", PilotActivityParticipation.PILOT_ACTIVITY_PARTICIPATION, new OrderField[] { PilotActivityParticipation.PILOT_ACTIVITY_PARTICIPATION.ACTIVITY_ID }, false);
        public static Index PILOT_ACTIVITY_PARTICIPATION_FK_PILOT_ACTIVITY_PARTICIPATION_PLANE_ID = Internal.createIndex("fk_pilot_activity_participation_plane_id", PilotActivityParticipation.PILOT_ACTIVITY_PARTICIPATION, new OrderField[] { PilotActivityParticipation.PILOT_ACTIVITY_PARTICIPATION.PLANE_ID }, false);
        public static Index PILOT_ACTIVITY_PARTICIPATION_ID = Internal.createIndex("id", PilotActivityParticipation.PILOT_ACTIVITY_PARTICIPATION, new OrderField[] { PilotActivityParticipation.PILOT_ACTIVITY_PARTICIPATION.ID }, true);
